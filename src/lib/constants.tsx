...
export const MENU_ITEMS: DemoMenuItem[] = [
  ...
  { id: 8, name: "Veg Fried Rice", category: "Curries", price: 179, rating: 4.5, reviews: 167, tag: "Vegetarian", calories: 520, veg: true, spicy: 0, tags: ["rice", "veg", "chinese"], allergens: ["soy"], desc: "Wok-tossed veg rice — Indo-Chinese favourite.", img: "https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400&h=300&fit=crop&q=80" },
