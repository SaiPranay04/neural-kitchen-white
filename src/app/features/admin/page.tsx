        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            {[
              ...
              { icon: <PieChart size={22} />, title: "Category Breakdown", desc: "Understand your revenue mix — biryani, tandoor, dosa, curries, and sweets. Optimize your menu based on actual sales data.", color: C.purple },
