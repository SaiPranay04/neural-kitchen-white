        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 20 }}>
            {[
              ...
              { icon: <Users size={28} />, title: "Staff & Floor Ops", tagline: "Kitchen and waiter in sync.", desc: "One console for managers — live KDS tickets, waiter table map, guest requests, and ready-to-serve handoff. Role-gated logins for kitchen and floor staff keep tablets simple.", color: C.rose, link: "/features/admin", stats: "Role-gated floor access" },
            ].map((f, i) => (
              <motion.div key={i}
