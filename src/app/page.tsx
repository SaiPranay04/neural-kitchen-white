      ...
      <section style={{ padding: "100px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 20 }}>
            {[
              { icon: <UtensilsCrossed size={28} />, title: "Interactive Digital Menus", tagline: "Beautiful. Real-time. QR-powered.", desc: "Guests scan a QR code and get a live menu on their phone. When paneer or biryani portions run out, those dishes vanish instantly — no awkward 'sorry, it's over' at the table.", color: C.orange, link: "/features/menu", stats: "3x upsell conversion" },
              { icon: <ChefHat size={28} />, title: "Kitchen Display System", tagline: "Zero paper. Zero chaos.", desc: "Color-coded tickets land on the right station — tandoor, dosa, Chinese, sweets. Chefs see modifications, timers, and rush alerts. Average ticket time drops by 20%.", color: C.emerald, link: "/features/kds", stats: "20% faster tickets" },
              { icon: <Brain size={28} />, title: "Zara AI Copilot", tagline: "Your 24/7 operations assistant.", desc: "Zara predicts Sunday lunch rush and wedding-season volume. She warns before idli batter, coconut chutney, or cooking oil runs low — and answers guest questions in English or your regional language.", color: C.purple, link: "/features/ai", stats: "Predictive demand forecasting" },
              ...
              { icon: <Package size={28} />, title: "Inventory Intelligence", tagline: "Never run out. Never over-order.", desc: "Track basmati rice, paneer, dosa batter, and oil as plates go out. Auto-reorder alerts hit your phone before you hit zero. Waste tracking shows where money walks out the door.", color: C.cyan, link: "/features/platform", stats: "Auto low-stock alerts" },
              { icon: <Users size={28} />, title: "Catering Management", tagline: "Events without the spreadsheet chaos.", desc: "Quotations, guest counts, bulk ingredient calc, menu packages, advance payments, cooking schedules, venue dispatch, temp staff, and event profitability — built for restaurant + catering houses.", color: C.rose, link: "/features/catering", stats: "Strongest differentiator vs POS" },
            ].map((f, i) => (
              <motion.div key={i}
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20 }}>
            {[
              ...
              { icon: <MessageSquare size={22} />, title: "Built for Indian kitchens", desc: "Handles multi-station service — tandoor, dosa counter, biryani, Chinese — with separate routing that matches how you actually cook." },
